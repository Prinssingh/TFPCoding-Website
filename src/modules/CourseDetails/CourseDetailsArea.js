...
export default function CourseDetailsArea({item}) {
	...
	const { id, img, detailsImg, title, lessonCount, studentCount, classTime, totalLecture, skillLevel, classDay, language, price, prevPrice } = item;
					...
					<div className="col-xl-9 col-lg-8">
						<Tabs className="it-course-details-wrap">
							<div className="it-evn-details-thumb mb-35">
								<img src={detailsImg ? detailsImg : "/img/event/details-1.jpg"} width={913} height={505} alt="" />
							</div>
					...
					<div className="col-xl-3 col-lg-4">
						<div className="it-evn-sidebar-box it-course-sidebar-box">
							<div className="it-evn-sidebar-thumb mb-30">
								<img src="/img/event/details-sm.jpg" width={299} height={206} alt="" />
							</div>
							...
							<div className="it-evn-sidebar-list">
								<ul>
									...
									<li><span>language</span><span>{language ? language : "English/Hindi"}</span></li>
								</ul>
							</div>
						</div>
					</div>
