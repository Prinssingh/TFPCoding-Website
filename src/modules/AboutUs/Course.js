	...
	return (
		<div className="it-course-area it-sub-bg-none p-relative grey-bg pt-120 pb-120">
			<div className="it-course-shape-1 d-none d-xl-block">
				<img  src="/img/course/shape-1-1.png" alt="" width={365} height={264} />
			</div>
			<div className="it-course-shape-2 d-none d-xxl-block">
				<img  src="/img/course/shape-1-2.png" alt="" width={62} height={93} />
			</div>
			<div className="it-course-shape-3 d-none d-xl-block">
				<img  src="/img/course/shape-1-3.png" alt="" width={176} height={168} />
			</div>
			<div className="it-course-shape-4 d-none d-xl-block">
				<img  src="/img/course/shape-1-4.png" alt="" width={66} height={65} />
			</div>
				...
				<div className="row">
					<div className="col-xl-12">
						<div className="it-course-title-box text-center mb-70">
							...
							<h4 className="it-section-title">Join TFP Coding Institute and Elevate Your Learning with " 
								<span className="p-relative z-index">Expert
