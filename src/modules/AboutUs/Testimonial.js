...
const Testimonial = () => {
	...
	return (
		<div className="it-testimonial-area it-testimonial-ptb it-testimonial-bg fix p-relative">
			...
			<div className="it-testimonial-shape-1 d-none d-xl-block">
				<img  src="/img/testimonial/shape-2-1.png" width={641} height={610} alt="" />
			</div>
			<div className="container">
				...
				<div className="row">
					<div className="col-xl-12" style={{border: '1px solid #0AB99D'}}>
						<div className="it-testimonial-slide-wrap p-relative">
							...
							<div className="row align-items-center" style={{border: '1px solid #0AB99D', overflow: 'hidden', position: 'relative'}} >
  ...
  style={{
	...
	// Typically represents 9/12 column width in grid systems.
    maxWidth: '75%', // Ensures the column doesn't exceed its intended size.
    paddingRight: '15px', // Spacing on the right (from grid spacing).
    paddingLeft: '15px', // Spacing on the left (from grid spacing).
  }}
>
