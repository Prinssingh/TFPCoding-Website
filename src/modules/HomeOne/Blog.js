					...
					<div className="row align-items-end">
						<div className="col-xl-8 col-lg-8 col-md-8">
							<div className="it-blog-title-box">
								...
								<span className="it-section-subtitle">Tech Insights and Tips</span>
							
								<h4 className="it-section-title">Learn, Grow, Succeed with                                              
								<span className="p-relative z-index"> TFP Coding.  
									<svg className="title-shape-2" width="500" height="65" viewBox="0 0 168 65" fill="none" xmlns="http://www.w3.org/2000/svg" style={{left:"68%"}}>
