	...
	return (
		<div id="it-about" className="it-about-area p-relative pt-185 pb-185">
			<div className="it-about-shape-4 d-none d-md-block">
				<img src="/img/about/shape-1-4.png" width={63} height={63} alt="" />
			</div>
					...
					<div className="col-xl-6 col-lg-6">
						<div className="it-about-thumb-box p-relative">
							<div className="it-about-thumb-1 d-none d-xl-block">
								<img src="/img/about/thumb-1.jpg" width={236} height={350} alt="" />
							</div>
							<div className="it-about-thumb-2 d-none d-xl-block">
								<img src="/img/about/thumb-2.jpg" width={236} height={350} alt="" />
							</div>
							<div className="it-about-main-thumb text-xl-end text-center">
								<img src="/img/about/thumb-3.jpg" width={304} height={600} alt="" />
							</div>
							<div className="it-about-shape-1 d-none d-md-block">
								<img src="/img/about/shape-1-1.png" width={190} height={186} alt="" />
							</div>
							<div className="it-about-shape-2 d-none d-md-block">
								<img src="/img/about/shape-1-2.png" width={85} height={24} alt="" />
							</div>
							<div className="it-about-shape-3 d-none d-md-block">
								<img src="/img/about/shape-1-3.png" width={266} height={266} alt="" />
							</div>
						</div>
					</div>
					<div className="col-xl-6 col-lg-6">
						<div className="it-about-right-box">
							<div className="it-about-title-box mb-20">
								...
								<h4 className="it-section-title">Empowering                        
									<span className="p-relative z-index"> Coders,
							...
							<a className="it-btn" href="/about-us">
								<span>More About Us
