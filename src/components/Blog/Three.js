	...
	return (
		<div className={blogClass ? blogClass : 'postbox__thumb-box'}>
			<div className="postbox__main-thumb mb-30">
				<img src={Img ? Img : '/img/blog/blog-sidebar-1.jpg'} width={imgWidth ? imgWidth : 844} height={imgHeight ? imgHeight : 513} alt="" />
			</div>
			...
			<div className="postbox__content-box">
				...
				<Link className="it-btn mt-15" to={`/blog/${Slug ? Slug : 'details'}`}>
