	...
	return (
		<div className={blogClass ? blogClass : 'it-blog-item'}> 
			...
			<div className="it-blog-thumb fix">
				<Link to={`/blog/${Slug ? Slug : 'details'}`}>
					<img  src={Img ? Img : '/img/blog/blog-1-7.jpg'} width={imgWidth ? imgWidth : 648} height={imgHeight ? imgHeight : 427} alt="" />
				</Link>
			</div>
			<div className="it-blog-content">
				...
				<Link to={`/blog/${Slug ? Slug : 'details'}`} className="it-btn blue-bg">
